<div id="third-submenu">
    <a href="index.php?page=settings&subpage=users">Account List</a>  <a href="index.php?page=settings&subpage=users&action=create">Add Account</a> <h>Search</h> <input type="text"/>
</div>
<div id="subcontent">
    <?php
      switch($action){
